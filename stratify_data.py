...
def parse_args():
    ...
    parser.add_argument("--val-size", float, default=0.1, help="Proportion of genomes for validation. Default = 0.1")
    parser.add_argument("--test-size", float, default=0.1, help="Proportion of genomes for testing. Default = 0.1.")
    parser.add_argument("--outpref", str, default="stratified_genomes", help="Output prefix. Default = stratified_genomes")
...
def main():
    ...
    for cluster in cluster_dict.keys():
        ...
        num_to_move = int(len(genome_list) * (train_size / 100))
        random.shuffle(genome_list)

        # remove genomes to new list
        #train_genomes.update(genome_list[:num_to_move])
