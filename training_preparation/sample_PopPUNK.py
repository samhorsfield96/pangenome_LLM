...
def parse_args():
    ...
    parser.add_argument("--min", type=int, default=100, help="Minimum number of genomes to sample per cluster. Defalt = 100")
...
def main():
    ...
    for cluster in cluster_dict.keys():
        ...
        if num_to_move < min_number:
            num_to_move = min_number
